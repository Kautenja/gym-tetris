...
#     ./main.sh test
#     ./main.sh deployment
#     ./main.sh cli --env TetrisA-v0 --actionspace simple
#     ./main.sh random --env TetrisA-v0 --steps 100
#
...
"cli" | "play")
  "${PYTHON}" -m gym_tetris._app.cli "$@"
  exit 0
  ;;

"random")
  "${PYTHON}" -m gym_tetris._app.cli --mode random "$@"
  exit 0
  ;;
